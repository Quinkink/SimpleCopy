...
class ConfigView(baseFrame.BaseView):
    ...
    def __init__(self, master):
        ...
        self.button3.grid(row=2, column=0, columnspan=1, ipadx=0, ipady=0, padx=4, pady=2, sticky=E+W)
        self.button3.grid_columnconfigure(0, weight=1)

        self.entry1 = tk.Entry(self, textvariable=self.entry1Text)
        self.entry1.grid(row=2, column=1, columnspan=5, ipadx=0, ipady=0, padx=2, pady=0, sticky=N+E+W+S)
        self.entry1.grid_columnconfigure(0, weight=1)

        self.button4 = tk.Button(self, width=0, text='')
        self.button4.grid(row=3, column=0, columnspan=1, ipadx=0, ipady=0, padx=4, pady=2, sticky=E+W)
        self.button4.grid_columnconfigure(0, weight=1)

        self.entry2 = tk.Entry(self, textvariable=self.entry2Text)
        self.entry2.grid(row=3, column=1, columnspan=5, ipadx=0, ipady=0, padx=2, pady=0, sticky=N+E+W+S)
        self.entry2.grid_columnconfigure(0, weight=1)

        self.button1 = tk.Button(self, width=0, text='')
        self.button1.grid(row=4, column=0, columnspan=3, ipadx=0, ipady=0, padx=4, pady=2, sticky=E+W)
        self.button1.grid_columnconfigure(0, weight=1)

        self.button2 = tk.Button(self, width=0, text='')
        self.button2.grid(row=4, column=3, columnspan=3, ipadx=0, ipady=0, padx=4, pady=2, sticky=E+W)
